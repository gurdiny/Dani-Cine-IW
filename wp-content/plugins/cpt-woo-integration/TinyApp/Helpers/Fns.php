...
class Fns {
	...
	public static function verify_nonce() {
		$nonce = isset( $_REQUEST[ cptwooint()->nonceId ] ) ? sanitize_text_field( $_REQUEST[ cptwooint()->nonceId ] ) : null;
	...
	public static function get_options() {
		...
		$defaults = apply_filters( 'cptwooint_default_settings', $defaults );
	...
	public static function pro_feature_list() {
		return [
			...
			[
				'title' => 'Inventory - Add SKU',
				'desc'  => 'Product SKUs are unique identifiers, Similar to product.',
			],
			[
				'title' => 'Inventory - Stock management',
				'desc'  => 'Track stock quantity for the products.',
			],
			[
				'title' => 'Inventory - Stock status',
				'desc'  => 'Stock status - In stock, Out of stock, On backorder.',
			],
			[
				'title' => 'Inventory - Sold individually',
				'desc'  => 'Available for purchase separately.',
			],
			[

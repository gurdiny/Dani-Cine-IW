...
class SpecialDiscount extends Discount {
	...
	public function the_options(): array {
		return [
			//'plugin_name'    => 'Exciting News: Custom Post Type Woocommerce Integration Pro',
			...
			'notice_message' => "<b>Exciting News:</b> Product Type - <b> Variable product/Grouped Product </b> feature released, Prior to returning to our regular pricing plan, here's a coupon for you.</b> 
			with <b>UP TO 20% OFF</b>! Limited time offer!!"
		];

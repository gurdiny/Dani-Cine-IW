...
class AdminMenu {
	...
	public function register_admin_menu() {
		...
		$tab_title = apply_filters( 'cptwooint/add/get-pro/submenu/label', esc_html__( 'Get license', 'cptwooint' ) );
			...
			<div class="cptwooint-pro-page-wrapper" >
				...
				<div id="cptwooint-pro-page-wrapper" >
						   ...
						   <?php } ?>
							...
							<li class="footer-text" >
								<div class="footer text">
									<a style="color: #1677ff;display: flex;align-items: center;gap: 5px;font-weight: 600;" target="_blank" href="https://www.wptinysolutions.com/tiny-products/cpt-woo-integration//"> Visit Our Website <span class="dashicons dashicons-arrow-right-alt"></span></a>
								</div>
					...
					<div  class="columns" >
						<section id="money_back_guarantee" style="margin: 0;height: 100%;box-sizing: border-box;padding-top:50px;">
							...
							<img style="max-width: 100%;" src="<?php echo cptwooint()->get_assets_uri( 'images/pngtree-gold-premium-quality-100-money-back-guaranteed-2.jpg' ); ?>" alt="">
				...
				<script>
					...
					var handler = FS.Checkout.configure({
						...
						image:      'https://www.wptinysolutions.com/wp-content/uploads/2023/08/cpt-woo-icon-128x128-1.png'
					});

					$('#purchase').on('click', function (e) {
						handler.open({
							name     : 'Custom Post Type Woocommerce Integration Pro',

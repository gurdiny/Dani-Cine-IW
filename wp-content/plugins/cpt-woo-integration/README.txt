...
Tags: add custom post type to wooCommerce, Use WooCommerce for payments only, cpt woocommerce integration, woocommerce custom post type support, donations in woocommerce
...
Integrate custom post type with WooCommerce. Simplify selling access to custom post types. Use WooCommerce for payments or accept donations.
...
== 🏆 Others Plugin Support ==
**LearnPress**: LearnPress WooCommerce Integration, Enhance your e-learning platform with seamless integration between LearnPress and WooCommerce.

Experience automated user access to courses upon the completion of WooCommerce orders, ensuring a smooth and efficient learning journey.
Optimize your educational website effortlessly with this powerful compatibility feature. [LearnPress Integration Docs](https://docs.wptinysolutions.com/cpt-woo-integration/docs/learnpress-compatibility)

**ACF**: ACF meta field already added for product price its also can integate with woocommerce.
Please check documentation. [ACF Integration Docs](https://docs.wptinysolutions.com/cpt-woo-integration/docs/acf-compatibility)
...
== 🏆 Integrate WooCommerce with a WordPress custom post type ==

To Integrate custom post type with woocommerce follow below step:
...
= 1.3.4 ( March 21, 2024 ) =
* Fixed: Issue with JetEngine and Elementor Pro

= 1.3.3 ( March 02, 2024 ) =
* Fixed: Posts Type Support For ACF
* Fixed: Admin Panel Design
* Remove: Remove Un-necessary Css
* Support: JetEngine Plugin Error Fix

= 1.3.2 ( February 17, 2024 ) =
* Fixed: Addons Compatibility For Product Review

= 1.3.1 ( February 16, 2024 ) =
* Remove: Wc Photoswipe Js Archive Page
* Remove: Wc Default Meta Key Form CPT
* Fixed: Comment Template Issue
* Fixed: Security Update
* Support: Addons Compatibility For Product Review
...
= 1.2.4 ( January 13, 2024 ) =
* Fixed: Activation Issue

= 1.2.3 ( January 01, 2024 ) =
* Added: Product type Column
* Fixed: Price issue

= 1.2.2 ( 15 December, 2023 ) =
* Fixed: Price meta issue.

= 1.2.1 ( 15 December, 2023 ) =
* Added: Addons Support For Grouped Product
* Added: LearnPress WooCommerce Integration
...
= 1.1.5 ( November 25, 2023 ) =
* Added: Addons Support

= 1.1.4 ( November 17, 2023 ) =
* Fixed: Sale Price Issue comma decimals format

= 1.1.3 ( November 12, 2023 ) =
* Fixed: Sale Price Issue

= 1.1.2 ( November 12, 2023 ) =
* Added: Regular Price and Sale Price Field Added
* Change: Custom Post Type Integration UI Upgrade

= 1.1.1 ( October 28, 2023 ) =
* Fixed: Some text Change

= 1.1.0 ( October 24, 2023 ) =
* Added: More meta field added

= 1.0.5 ( September 30, 2023 ) =
* Added: Added sale Price support

= 1.0.4 ( September 18, 2023 ) =
* Fixed: Checkout Page plugin support
* Change: Menu style change

1.0.3 ( August 24, 2023 )
* Fixed: HPOS Declare compatibility

1.0.2 ( August 10, 2023 )
* Fixed : PHP 8.2 Issue.

1.0.1 ( August 09, 2023 )
* Fixed Modal Issue

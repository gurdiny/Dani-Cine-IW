...
class Kadence_Blocks_Pro_Filter_Checkbox_Block extends Kadence_Blocks_Query_Children_Block {
	...
	public function build_html( $attributes, $unique_id, $content, $block_instance ) {
		...
		return sprintf(
			'<div class="wp-block-kadence-query-filter-checkbox%s %s" %s><fieldset class="kadence-filter-wrap">%s<div class="checkbox-options filter-refresh-container">%s</div></fieldset></div>',
			$unique_id,
			$classes_str,
